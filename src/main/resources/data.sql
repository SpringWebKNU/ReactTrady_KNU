...
INSERT INTO qna (id, title, content, created_at, member_id) VALUES
                                                                (1, '신발 반품 정책이 어떻게 되나요?', '신발이 맞지 않으면 반품할 수 있나요?', '2024-11-01 10:00:00', 1),
                                                                (2, '운동화 배송은 얼마나 걸리나요?', '운동화 배송 소요 시간이 얼마나 걸리나요?', '2024-11-02 12:30:00', 2),
                                                                (3, '50,000원 이상 구매 시 무료 배송이 되나요?', '50,000원 이상 구매하면 무료 배송 되나요?', '2024-11-03 15:00:00', 1),
                                                                (4, '주문한 신발을 어떻게 추적하나요?', '신발을 주문한 후 주문 상태를 어떻게 추적하나요?', '2024-11-04 09:45:00', 2);
